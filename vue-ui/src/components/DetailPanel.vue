    ...
    <template v-if="logsStore.curRequestId">
      ...
      <div class="stats-grid" v-if="curReq">
        <div class="all-badges">
          ...
          <span v-if="curReq.inputTokens != null" class="sbadge sm-badge"><span class="sm-l">输入Token</span><b>{{ fmtN(curReq.inputTokens) }}</b></span>
          <span v-if="curReq.outputTokens != null" class="sbadge sm-badge"><span class="sm-l">输出Token</span><b>{{ fmtN(curReq.outputTokens) }}</b></span>
